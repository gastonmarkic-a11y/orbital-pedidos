...
import { ACENTO, Rol, nAr } from './colabUtil'
...
type Item = {
  ...
  vistas: number | null; likes: number | null; publicado_at: string | null
  formato: string | null; por_que: string | null; como_orbital: string | null; aviso: string | null
...
function Tarjeta({ i }: { i: Item }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-black/10 p-3 flex flex-col gap-2">
      ...
      {i.por_que && <p className="text-[11px]"><b>Por qué funciona:</b> <span className="text-neutral-600">{i.por_que}</span></p>}
