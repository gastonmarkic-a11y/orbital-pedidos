...
// Naranja quemado: es el complementario del azul, así que salta a la vista y
// al mismo tiempo combina. Más vivo que esto (#F4511E, #FF5A1F) se ve más
// punchy pero el texto blanco baja de 4.5:1 de contraste y cuesta leerlo.
const CTA = '#D93A0B'
